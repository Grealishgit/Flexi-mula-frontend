    ...
    return (
        <div className="p-4 md:p-6 mt-16 mb-6">
            ...
            <div className="p-4 md:p-6 bg-white shadow-md rounded-lg">
                {/* Title */}
                <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-4">LEVEL 1 ACCOUNTS</h2>

                {/* Search Input */}
                <input
                    type="text"
                    placeholder="Search referrals by username or mobile"
                    className="w-full font-semibold p-3 border border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-1 focus:ring-blue-500"
                />

                {/* Earnings & Active Users */}
                <div className="bg-blue-50 text-blue-500 p-4 rounded-md mb-4">
                    <p className="font-bold">Total Level 1 Earnings: KES 1,950.00</p>
                    <p className="font-bold">Total Level 1 Active Users: 13</p>
                </div>
